...
public class Backbone {
    ...
    try {
      ...
      while ((linha = buffRead.readLine()) != null) {
        ...
        if (partes.length == 3) {
          ...
          System.out.println("Conexao criada: " + idOrigem + " -> " + idDestino + " | custo do caminho: " + peso);
        } // fim do if
      } // fim do while
  ...
  /*
   * Metodo: gerarConexao
   * Funcao: criar as conexoes entre os roteadores
   * Parametros: r1 = roteador, r2 = roteador, peso = custo da conexao
   * Retorno: void
   */
